...
import TableWidget from '../../../componentes/TableWidget';
import {
...
export const ChatRenderer: React.FC<ChatRendererProps> = ({ message }) => {
	...
	switch (message.type) {
		...
		case 'table': {
			...
			const tableData = (message as any).data || (message as any).tableData;
			if (!tableData || !tableData.data) {
				// Fallback to default rendering if no table data
				return (
					<div
						className={`${
